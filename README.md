...
Если смягчить нечем, система говорит и это. На честной командировке ответ
получился такой: ни одно отдельное изменение не помогает, потому что при
вероятности 3% фиксированная стоимость разбора случая делает подтверждение
дешевле пропуска **при любой сумме** — даже при 1 590 ₸ разрыв всего 2 ₸.
Это свойство стоимостной модели, и лучше сказать о нём вслух, чем показать
пустой список.
